...
{
    /// <inheritdoc />
    public partial class concertTicketFirstModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accessories_Concerts_ConcertId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionRefId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_TransactionRefId",
                table: "Orders",
                column: "TransactionRefId",
                unique: true,
                filter: "[TransactionRefId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seats_ConcertId_Section_Row_SeatNumber",
                table: "Seats",
                columns: new[] { "ConcertId", "Section", "Row", "SeatNumber" },
                unique: true);
        }
